...
class Rossmann(object):
    def __init__(self):
        #self.home_path = ''     # seria pra usar a concatenação de string para colocar o caminho certo dos arquivos abaixo
    ...
    def data_preparation(self, df5):
        ...
        ## 5.1 Padronização (ou normalização, segundo Meigarom)
